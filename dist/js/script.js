...
document.addEventListener('DOMContentLoaded', () => {
  ...
  class MenuCard {
    ...
    render() {
      ...
      if (this.classes.length === 0) {
        this.element = 'menu__item'; //на случай если пользователь не ввел menu__item
  ...
  const div = new MenuCard("img/tabs/vegy.jpg", "vegy", 'Меню "Фитнес"', 'Меню "Фитнес" - это новый подход к приготовлению блюд: больше свежих овощей и фруктов. Продукт активных и здоровых людей. Это абсолютно новый продукт с оптимальной ценой и высоким качеством!', 9, '.menu .container', 'menu__item').render();
