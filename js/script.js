...
document.addEventListener('DOMContentLoaded', () => {
    ...
    //     if (e.target == document.getElementById("male")) {
    //         sex = "male";
    //         document.getElementById("male").classList.add("calculating__choose-item_active");
    //         document.getElementById("female").classList.remove("calculating__choose-item_active");
    //     } else if (e.target == document.getElementById("female")) {
    //         sex = "female";
    //         document.getElementById("female").classList.add("calculating__choose-item_active");
    //         document.getElementById("male").classList.remove("calculating__choose-item_active");
    //     }
    // });

    // document.querySelector(".calculating__choose.calculating__choose_medium").addEventListener("change", () => {
    //     height = +document.getElementById("height").value;
    //     weight = +document.getElementById("weight").value;
    //     age = +document.getElementById("age").value;
    // });

    // const physicalActivity = document.querySelector(".calculating__choose.calculating__choose_big");

    // physicalActivity.addEventListener("click", (e) => {
    //     physicalActivity.querySelectorAll(".calculating__choose-item").forEach(item => {
    //         if (e.target == item) {
    //             physicalActivity.querySelectorAll(".calculating__choose-item").forEach(item => {
    ...
    // document.querySelector(".calculating__field").addEventListener("click", () => {
    //     calcTotal();
    // });
    // document.querySelector(".calculating__field").addEventListener("change", () => {
    //     calcTotal();
    // });
    // calcTotal();
